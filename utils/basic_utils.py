...
def load_json(filename, use_utf8=True):
...
def get_show_name_from_vid_name(vid_name):
    """
...
def mk_url_from_vid_name(vid_name):
    """
    bbt:
    https://bvisionweb1.cs.unc.edu/jielei/project/videoQA/videos/bbt_clips/bbt01/s01e02_seg01_clip_00.mp4

    others:
    https://bvisionweb1.cs.unc.edu/jielei/project/videoQA/videos/friends_clips/friends_s04/friends_s04e18_seg02_clip_12.mp4
    """
    base_url = "https://bvisionweb1.cs.unc.edu/jielei/project/videoQA/videos/"
    show_name = get_show_name_from_vid_name(vid_name)
    if show_name == "bbt":
        season_no = vid_name[1:3]
        rel_path = f"bbt_clips/bbt{season_no}"
    else:
        season_no = vid_name.split("_")[1][:3]
        rel_path = f"{show_name}_clips/{show_name}_{season_no}"
    return join(base_url, rel_path, f"{vid_name}.mp4")
