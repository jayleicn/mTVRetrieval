...
class StartEndDataset(Dataset):
    ...
    def __init__(self, dset_name, data_path, desc_bert_path_or_handler, sub_bert_path_or_handler,
                 ...
                 vid_feat_path_or_handler, clip_length, ctx_mode="video", lang="en",
        ...
        # prepare desc data
        self.data = self.load_and_reformat(data_path)
    ...
    def load_and_reformat(self, data_path):
        """convert entry 'descs' to 'desc' based on the specified self.lang"""
        ...
        for d in datalist:
            ...
            for k in d:
                if k != "descs":
                    ...
                    _d["desc"] = d["descs"][self.lang]
            reformatted.append(_d)
        return reformatted
...
class StartEndEvalDataset(Dataset):
    ...
    """
    def __init__(self, dset_name, eval_split_name, data_path=None, lang="en",
        ...
        self.max_ctx_len = max_ctx_len
        self.data_path = data_path
        self.query_data = self.load_and_reformat(data_path)
        if data_ratio != 1:
...
if __name__ == '__main__':
    from baselines.xml.config import BaseOptions
