...
from baselines.xml.inference import eval_epoch, start_inference
...
def get_datasets(opt, lang="en",
    ...
    return train_dataset, train_eval_dataset, eval_dataset
...
def start_training():
    ...
    train_dataset, train_eval_dataset, eval_dataset = \
        get_datasets(opt, lang=opt.lang,
